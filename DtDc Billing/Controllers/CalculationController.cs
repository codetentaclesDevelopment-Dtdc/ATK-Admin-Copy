...
namespace DtDc_Billing.Controllers
{
    public class CalculationController : Controller
    {
        ...
        // GET: Calculation
        [HttpPost]
        public ActionResult CalulateAmt(string Consignment, string custid, string Pincode, string mode,double charweight, string type)
        {
            ...
            if(Consignment.ToLower().StartsWith("ge"))
            {
                ...
                return Json(new { Amount = getAmount });
            }
